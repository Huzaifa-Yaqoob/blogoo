...
export default function SearchByCategory() {
  ...
  const getFromCategory = (category: any) => {
    client.setQueryData("blogs", getBlogsByCategories.bind(null, category.value));
    // const blog: any = useQuery("blogs", getBlogsByCategories);
  };
